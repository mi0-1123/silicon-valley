...
//    pinMode(15, OUTPUT);        // LED こいつをHighにしてもlowにしても何も変化しない
    FastLED.addLeds<NEOPIXEL, 11>(leds, 1); // FastLED setup for RGB LEDs -NEOPIXEL系のLED
    SimbleeCOM.begin();
...
void SimbleeCOM_onReceive(unsigned int esn, const char* payd1, int len, int rssi) {
